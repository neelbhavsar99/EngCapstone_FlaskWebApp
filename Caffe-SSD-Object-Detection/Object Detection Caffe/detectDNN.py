...
ap.add_argument(
    ...
    required=True,
    help=
    '/Users/neelbhavsar/Desktop/Programming/capstoneproj/Caffe-SSD-Object-Detection/Object Detection Caffe/Caffe/SSD_MobileNet_prototxt.txt'
)
ap.add_argument(
    "-m",
    "--model",
    required=True,
    help=
    '/Users/neelbhavsar/Desktop/Programming/capstoneproj/Caffe-SSD-Object-Detection/Object Detection Caffe/Caffe/SSD_MobileNet.caffemodel'
)
